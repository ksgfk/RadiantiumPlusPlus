...
class Rectangle final : public Shape {
 public:
  Rectangle(BuildContext* ctx, const Matrix4& toWorld, const ConfigNode& cfg) {
    ...
    _giveEmbreeData = (EmbreeRectangle*)AlignedMalloc(32, sizeof(EmbreeRectangle));
  }
