...
Spectrum Fresnel::Conductor(Float cosThetaI, const Spectrum& eta, const Spectrum& k) {
  Float cosThetaI2 = cosThetaI * cosThetaI,
        sinThetaI2 = Float(1) - cosThetaI2,
        sinThetaI4 = sinThetaI2 * sinThetaI2;
  auto etaR = eta,
       etaI = k;
  auto temp1 = etaR.cwiseProduct(etaR) - etaI.cwiseProduct(etaI) - Spectrum::Constant(sinThetaI2);
  ...
  auto term1 = a2pb2 + Spectrum::Constant(cosThetaI2);
  ...
  return Spectrum((rs + rp) * Float(0.5));
}
