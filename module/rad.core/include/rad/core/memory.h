...
extern "C" {
#endif
RAD_EXPORT_API void* AlignedMalloc(std::size_t alignment, std::size_t size);
RAD_EXPORT_API void AlignedFree(void* ptr);
#if defined(__cplusplus)
}
#endif
}  // namespace Rad
...
/**
 * @brief 分块储存的二维数组
 * https://pbr-book.org/3ed-2018/Utilities/Memory_Management#Blocked2DArrays
 */
